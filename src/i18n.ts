...
const en = {
  ...
  shiftEnds: 'SHIFT ENDS IN', stationStability: 'STATION STABILITY', leaveAria: 'Leave session', assignment: 'YOUR ASSIGNMENT', youAre: 'YOU',
  ...
  incidentModule: 'INCIDENT MODULE', resolved: 'RESOLVED', active: 'ACTIVE', quantumRouter: 'Quantum Router', reactorCalibration: 'Reactor Calibration', translationMatrix: 'Translation Matrix', callerAuthentication: 'Caller Authentication', temporalPacket: 'Temporal Packet Reconstruction', consentHandshake: 'Consent Handshake',
  ...
  setDials: 'Follow the three energy-path cards, move each dial to its landing position, then engage.', dial: 'DIAL', increaseDial: 'Increase dial', decreaseDial: 'Decrease dial', core: 'CORE', engage: 'ENGAGE CALIBRATION',
  ...
  verifyCaller: 'Cross-reference the timestamp and private challenge response. Select the only channel that satisfies both.', acceptChannel: 'VERIFY CHANNEL',
  orderPackets: 'Ask for the live timestamps, reading direction, and checksum chain. Select all four blocks in transmission order.', resetPackets: 'RESET ORDER', rebuildPacket: 'RECONSTRUCT MESSAGE', restoredMessage: 'RECONSTRUCTED MESSAGE',
  consentSubject: 'CONSENT SUBJECT', consentInstruction: 'Cross-check the response, allowed scope, and phase order. Silence is never consent.', consentWaiting: 'SAFETY LOCK: Resolve every identity, message, and route check before requesting consent.', consentResponse: 'VERIFIED RESPONSE', permissionSequence: 'PERMISSION SEQUENCE', resetConsent: 'RESET HANDSHAKE', submitConsent: 'CONFIRM CONSENT',
...
const de: typeof en = {
  ...
  shiftEnds: 'SCHICHTENDE IN', stationStability: 'STATIONSSTABILITÄT', leaveAria: 'Sitzung verlassen', assignment: 'DEINE AUFGABE', youAre: 'DU',
  ...
  incidentModule: 'VORFALLMODUL', resolved: 'GELÖST', active: 'AKTIV', quantumRouter: 'Quantenrouter', reactorCalibration: 'Reaktorkalibrierung', translationMatrix: 'Übersetzungsmatrix', callerAuthentication: 'Anrufer-Authentifizierung', temporalPacket: 'Zeitpaket-Rekonstruktion', consentHandshake: 'Zustimmungs-Handshake',
  ...
  setDials: 'Folgt den drei Energiepfad-Karten, dreht jeden Regler auf seine Zielposition und aktiviert den Kern.', dial: 'REGLER', increaseDial: 'Regler erhöhen', decreaseDial: 'Regler verringern', core: 'KERN', engage: 'KALIBRIERUNG AKTIVIEREN',
  ...
  verifyCaller: 'Gleicht Zeitstempel und private Prüfantwort ab. Wählt den einzigen Kanal, der beide Bedingungen erfüllt.', acceptChannel: 'KANAL PRÜFEN',
  orderPackets: 'Fragt nach aktuellen Zeitstempeln, Leserichtung und Prüfsummenkette. Wählt alle vier Blöcke in Übertragungsreihenfolge.', resetPackets: 'REIHENFOLGE LÖSCHEN', rebuildPacket: 'NACHRICHT REKONSTRUIEREN', restoredMessage: 'WIEDERHERGESTELLTE NACHRICHT',
  consentSubject: 'ZUSTIMMUNG VON', consentInstruction: 'Gleicht Antwort, erlaubten Umfang und Phasenreihenfolge ab. Schweigen ist niemals Zustimmung.', consentWaiting: 'SICHERHEITSSPERRE: Löst alle Identitäts-, Nachrichten- und Routenprüfungen, bevor ihr Zustimmung anfordert.', consentResponse: 'GEPRÜFTE ANTWORT', permissionSequence: 'BERECHTIGUNGSFOLGE', resetConsent: 'HANDSHAKE LÖSCHEN', submitConsent: 'ZUSTIMMUNG BESTÄTIGEN',
