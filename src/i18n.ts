...
const en = {
  ...
  incidentModule: 'INCIDENT MODULE', resolved: 'RESOLVED', active: 'ACTIVE', quantumRouter: 'Quantum Router', reactorCalibration: 'Reactor Calibration', translationMatrix: 'Translation Matrix', callerAuthentication: 'Caller Authentication',
...
const de: typeof en = {
  ...
  incidentModule: 'VORFALLMODUL', resolved: 'GELÖST', active: 'AKTIV', quantumRouter: 'Quantenrouter', reactorCalibration: 'Reaktorkalibrierung', translationMatrix: 'Übersetzungsmatrix', callerAuthentication: 'Anrufer-Authentifizierung',
